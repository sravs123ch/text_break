...
//   // Function to handle DOCX download
//   const handleDownloadDocx = async (editor) => {
//     // ... (existing download function remains unchanged)
//   };
...
//       {/* 🔹 Editor background with page simulation */}
//       <Box
//         sx={{
//           flex: 1,
//           background: "#f3f3f3", // gray like Word
...
//         }}
//       >
//         {/* Page container with dynamic height based on content */}
//         <Box
//           sx={{
//             position: "relative",
//             width: "794px", // A4 width
//           }}
//         >
//           {/* Render multiple page elements based on content */}
...
//               data-lexical-page
//             >
//               {/* Only show content in the first page container */}
//               {index === 0 && (
//                 <>
//                   <RichTextPlugin
//                     contentEditable={
...
//   // Estimate how many "pages" are needed
//   const estimatePageCount = () => {
//     const editorElement = document.querySelector("[data-lexical-editor]");
//     if (!editorElement) return 1;

//     const contentHeight = editorElement.scrollHeight;
//     const pageHeight = 1123; // A4 height in px (96 DPI approx.)
...
//         border: "1px solid #ddd",
//         position: "relative",
//         overflow: "hidden", // ⬅️ important to keep content inside
//       }}
//     >
//       <Box
//         sx={{
...
// function LexicalEditorWrapper() {
//   const [pages, setPages] = useState([{ top: 0, height: 1123 }]);
//   const hiddenEditorRef = useRef(null); // 🔹 hold hidden editor
//   const [editorContent, setEditorContent] = useState(null); // 🔹 clone snapshot
// 	// Function to handle DOCX download
// 	const handleDownloadDocx = async (editor) => {
// 		const editorState = editor.getEditorState();
// 		const blocks = [];
...
// 		saveAs(blob, "document.docx");
//   };
//   // recalc pages whenever content changes
//   useEffect(() => {
//     const contentEl = hiddenEditorRef.current;
//     if (!contentEl) return;
...
//     //   // keep snapshot for cloning
//     //   setEditorContent(contentEl.innerHTML);
//     // };
...
// 		const pageWidth = 794;   // A4 width in px (≈ 210mm @ 96dpi)
// 		const newPages = [];
// 		let pageIndex = 0;
// 		let usedHeight = 0;
...
// 			  if (!img.complete) {
// 				img.onload = () => {
// 				  scaleImageAndContinue(img, block, resolve);
// 				};
// 			  } else {
// 				scaleImageAndContinue(img, block, resolve);
// 			  }
...
// 		const scaleImageAndContinue = (img, block, resolve) => {
...
// 		  // scale ratio
// 		  const widthRatio = pageWidth / naturalWidth;
// 		  const heightRatio = pageHeight / naturalHeight;
// 		  const ratio = Math.min(widthRatio, heightRatio);
	  
// 		  const scaledWidth = naturalWidth * ratio;
// 		  const scaledHeight = naturalHeight * ratio;
	  
// 		  // persist inline styles
// 		  img.setAttribute(
// 			"style",
// 			`
...
// 			newPages.push({ top: pageIndex * pageHeight, height: pageHeight });
// 			pageIndex++;
// 			usedHeight = 0;
// 		  }
...
// 		  if (usedHeight + blockHeight > pageHeight) {
// 			newPages.push({ top: pageIndex * pageHeight, height: pageHeight });
// 			pageIndex++;
// 			usedHeight = 0;
// 		  }
...
// 		// Process all blocks (wait for images to load)
// 		Promise.all(blocks.map(processBlock)).then(() => {
// 		  if (usedHeight > 0 || newPages.length === 0) {
// 			newPages.push({ top: pageIndex * pageHeight, height: pageHeight });
// 		  }
...
//       {/* 🔹 Hidden continuous editor */}
//       <Box
//         ref={hiddenEditorRef}
//         className="editor-full-content"
//         sx={{
//           position: "absolute",
//           visibility: "hidden",
//           pointerEvents: "none",
...
//                 width: "100%",
//               }}
//               dangerouslySetInnerHTML={{ __html: editorContent || "" }} // 🔹 inject clone
//             />
//           </Box>
//         ))}
//       </Box>
